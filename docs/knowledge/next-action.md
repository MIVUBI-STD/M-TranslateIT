...
- ASR has 60 acceptance cases; TTS/My Voice has 30 synthesis cases, pre-training capture gates, artifact-aware multi-metric held-out candidate selection, and fail-closed preview listening before approval.
