pub fn register(builder: tauri::Builder<tauri::Wry>) -> tauri::Builder<tauri::Wry> {
    builder.invoke_handler(tauri::generate_handler![
        ...
        crate::commands::application_runtime::save_product_settings,
        crate::commands::application_runtime::apply_product_meeting_preset,
        ...
        crate::commands::application_runtime::start_product_voice_build,
