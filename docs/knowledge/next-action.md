...
- ASR has 60 acceptance cases; TTS/My Voice has 30 synthesis cases, pre-training capture gates, artifact-aware multi-metric held-out selection, evaluation-to-candidate binding, fail-closed preview listening, and post-approval build cleanup.
