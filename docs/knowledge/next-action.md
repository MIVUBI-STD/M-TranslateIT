...
- ASR has 60 acceptance cases; TTS/My Voice has 30 synthesis cases, pre-training capture gates, multi-metric held-out candidate selection, and enforced preview listening before approval.
